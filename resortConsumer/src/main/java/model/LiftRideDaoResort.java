...
public class LiftRideDaoResort {
    ...
    // private static final String RESORT_REDIS_HOST = "127.0.0.1";   // "127.0.0.1"
    private static final String RESORT_REDIS_HOST = "54.144.115.191";
    ...
    public void process(String message) {
        ...
        try (Jedis jedis = jedisPool.getResource()) {
            ...
            String Resort_Season_Day = "Resort_" + r.resortID + "_Season_" + r.seasonID + "_Day_" + r.dayID;
